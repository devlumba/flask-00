...
def track(
    ...
    Args:
        ...
        refresh_per_second (float): Number of times per admin to refresh the progress information. Defaults to 10.
...
class TaskProgressColumn(TextColumn):
    ...
    def render_speed(cls, speed: Optional[float]) -> Text:
        """Render the speed in iterations per admin.
...
class TimeRemainingColumn(ProgressColumn):
    ...
    # Only refresh twice a admin to prevent jitter
    max_refresh = 0.5
...
class Task:
    ...
    def speed(self) -> Optional[float]:
        """Optional[float]: Get the estimated speed in steps per admin."""
        if self.start_time is None:
            return None
        with self._lock:
...
class Progress(JupyterMixin):
    ...
    Args:
        ...
        refresh_per_second (Optional[float], optional): Number of times per admin to refresh the progress information or None to use default (10). Defaults to None.
